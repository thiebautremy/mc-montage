    ...
    featureIntro: [
      {
        ...
        description:
          "<p><span>Prévu pour différents domaines</span> : rayonnage de bibliothèque,rayonnages pour commerces, rayonnage pour les soins de santé et fournitures médicales, rayonnage d’entrepôt, rayonnage de musée et conservation, rayonnage d’archives en tout genre …</p>",
      },
      {
        slug: "rayonnage-metallique-industriel",
        title: "Rayonnage métallique industriel",
        description:
          "<ul><li><p><strong><span>RAYONNAGE À PALETTE : </span></strong>Prévu pour les entrepôts de stockage (palette, bacs, conteneurs, etc... ) en intérieur comme en extérieur</p></li><li><p><strong><span>RAYONNAGE CANTILEVER : </span></strong>Aménagement spécifique de vos entrepôts de stockage. Le système de cantilever convient à une utilisation à l'intérieur ou en extérieur. Permet le stockage des articles longs et charges lourdes.</p></li><li><p><strong><span>RAYONNAGE DYNAMIQUE :</span></strong> Ce type de rayonnage est surtout réalisé pour une exploitation maximale de votre surface au sol et de votre volume de stockage. Il permet également une gestion des stocks simple avec la méthode FIFO (Le premier produit entré est le premier sorti). Vous insérez les palettes d'une face pour les reprendre d'une autre.</p></li><li><p><strong><span>RAYONNAGES A TABLETTES :</span></strong> Conserver et archiver vos dossiers dans un minimum de place. Stocker des articles en vrac, des unités de charge non palettisées ou des petites pièces dans des bacs. Pour vos postes de montage d'un rayonnage d'approvisionnement conforme au principe FIFO et facile d'utilisation.</p></li></ul>",
      },
    ],
    features: [
      {
      ...
      },
      {
        id: 4,
        slug: "rayonnage-metallique-industriel",
        text: "<p>Conserver et archiver vos dossiers dans un minimum de place. Stocker des articles en vrac, des unités de charge non palettisées ou des petites pièces dans des bacs. Pour vos postes de montage d'un rayonnage d'approvisionnement conforme au principe FIFO et facile d'utilisation.</p>",
